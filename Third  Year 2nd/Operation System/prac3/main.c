 ...
 * Title: Practical 3 - LinkedList Exercise - main.C
 * Description:
                ...
                while(ptr != NULL)  /*while there is more to the string pointer*/
                    ...
                    if(strcmp(Input[0],"Push") == 0){ /*If the command is Push*/
                        ...
                        if(isChar(varb[0])==1){ /*check if the data is a valid character A-Z*/
                            push(&Head,varb[0]); /*Push to LinkedList*/
                        }
                    else{
                        fprintf(stderr,"Input not valid\n"); /*Print Error*/
                    }
                     ...
                     else if(strcmp(Input[0],"Append") == 0){ /*If the command is Push*/

                        char *varb=Input[1]; /*pointer points towards data*/
                        if(isChar(varb[0])==1){ /*check if the data is a valid character A-Z*/
                            append(&Head,varb[0]); /*Push to LinkedList*/
                        }
                    else{
                        fprintf(stderr,"Input not valid\n"); /*Print Error*/
                    }
                    }
                     else if(strcmp(Input[0],"InsertAfter") == 0){ /*If the command is Push*/

                        char *varb=Input[1]; /*pointer points towards data*/
                        char *varb2=Input[2];
                        if(isChar(varb[0])==1 && isChar(varb2[0])==1){ /*check if the data is a valid character A-Z*/
                            insertAfter(&Head,varb2[0],varb[0]); /*Push to LinkedList*/
                        }
                    else{
                        fprintf(stderr,"Input not valid\n"); /*Print Error*/
                    }
                    ...
                    else if(strcmp(Input[0],"InsertBefore") == 0){ /*If the command is Push*/

                        char *varb=Input[1]; /*pointer points towards data*/
                        char *varb2=Input[2];
                        if(isChar(varb[0])==1 && isChar(varb2[0])==1){ /*check if the data is a valid character A-Z*/
                            insertBefore(&Head,varb2[0],varb[0]); /*Push to LinkedList*/
                        }
                    else{
                        fprintf(stderr,"Input not valid\n"); /*Print Error*/
                    }
